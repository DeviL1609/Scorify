      ...
      <div class="contact-container">
        ...
        <div class="about-features">
          <h1 class="about-text2">
            <span>Discover our Introduction</span>
            <br />
            <span>and unique features</span>
          </h1>
          ...
          <div class="about-container3">
            <div class="about-container4">
              ...
              >
                ...
                <h2 class="feature-card4-text"><span>Embrace the Thrill: Introducing Scorify</span></h2>
                <span class="feature-card4-text1">
                  <span>
                  Introducing Scorify, your ultimate cricket companion, redefining the way you experience the thrill of the game. With an array of dynamic features, Scorify transforms every match into an immersive and engaging journey. From the moment you hit that 'Start' button, you're plunged into the heart of the action as the first innings kicks off. Experience the game like never before with an intuitive interface allowing you to effortlessly record every aspect of the match.
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <h2 class="feature-card4-text"><span>Dynamic Match Start-Up: Dive into the Action</span></h2>
                <span class="feature-card4-text1">
                  <span>
                  Whether it's a no ball, wide ball, or a combination of both, Scorify has you covered, ensuring every play is accurately captured. Seamlessly add wickets, dot balls, and runs with a simple tap, keeping track of each player's performance in real-time. Watch the excitement unfold ball by ball with live scoring, providing instant updates on the evolving match dynamics.
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <h2 class="feature-card4-text"><span>Seamless Scorekeeping: Every Play, Every Moment</span></h2>
                <span class="feature-card4-text1">
                  <span>
                  Setting targets has never been easier; simply enter your desired goal, and Scorify calculates the chase, keeping you informed on which team holds the upper hand. With a sleek display showcasing batsmen scores, current over details, and run rates, you'll always stay one step ahead, gaining valuable insights into the game's progression.
                  </span>
                </span>
              </div>
              <div
              ...
              >
                ...
                <h2 class="feature-card4-text"><span>Elevating the Experience: Welcome to Scorify</span></h2>
                <span class="feature-card4-text1">
                  <span>
                  Whether you're a casual fan or a die-hard enthusiast, Scorify elevates your cricket experience to new heights, delivering a comprehensive platform that keeps you glued to the action from start to finish. Welcome to a new era of cricketing excitement with Scorify – where every match is an adventure waiting to unfold.
                  </span>
                </span>
              </div>
            </div>
